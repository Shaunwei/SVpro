...
# DVE full session
# Saved on Tue Nov 19 21:56:43 2013
# Designs open: 1
...
#<Session mode="Full" path="/DCNFS/users/student/xwei/Desktop/ELEN603/final/IMAGEPROC/tb/DVEfiles//crash_11.19:21.56/dve_session11.19:21.56.tcl" type="Debug">
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 407} {height 944} {dock_state left} {dock_on_new_line true} {child_hier_colhier 251} {child_hier_coltype 147} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 323} {height 944} {dock_state left} {dock_on_new_line true} {child_data_colvariable 167} {child_data_colvalue 79} {child_data_coltype 69} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1919} {height 112} {dock_state bottom} {dock_on_new_line true}}
...
gui_open_source -id ${Source.1}  -replace -active uvm_pkg /projects/dft2005fall/bgreene/vcs/etc/uvm-1.1/uvm_pkg.sv
...
gui_zoom -window ${Schematic.1} -rect { {-828 -38247} {60221 8520} }
