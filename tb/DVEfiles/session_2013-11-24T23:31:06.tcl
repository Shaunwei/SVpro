...
gui_show_window -window ${TopLevel.1} -show_state maximized -rect {{0 22} {1913 988}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 405} {height 761} {dock_state left} {dock_on_new_line true} {child_hier_colhier 251} {child_hier_coltype 147} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 931
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 321} {height 761} {dock_state left} {dock_on_new_line true} {child_data_colvariable 167} {child_data_colvalue 79} {child_data_coltype 69} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 111]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 1854
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 111
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1913} {height 110} {dock_state bottom} {dock_on_new_line true}}
...
gui_open_source -id ${Source.1}  -replace -active imageproc_test_top.dut /DCNFS/users/student/xwei/Desktop/ELEN603/final/IMAGEPROC/tb/../rtl/imageproc.sv
gui_view_scroll -id ${Source.1} -vertical -set 228
...
gui_zoom -window ${Schematic.1} -rect { {-2825 -46838} {80826 4214} }
