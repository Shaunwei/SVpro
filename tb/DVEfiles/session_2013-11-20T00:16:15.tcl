...
# DVE full session
# Saved on Tue Nov 19 22:41:21 2013
# Designs open: 1
#   Sim: /DCNFS/users/student/xwei/Desktop/ELEN603/final/IMAGEPROC/tb/simv
# Toplevel windows open: 1
# 	TopLevel.1
#   Schematic.1: imageproc_test_top.dut.compute_xy
#   Source.1: imageproc_test_top.dut.compute_xy
#   Group count = 0
...
gui_show_window -window ${TopLevel.1} -show_state maximized -rect {{0 22} {1919 1177}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 406} {height 945} {dock_state left} {dock_on_new_line true} {child_hier_colhier 251} {child_hier_coltype 147} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 944
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 322} {height 945} {dock_state left} {dock_on_new_line true} {child_data_colvariable 167} {child_data_colvalue 79} {child_data_coltype 69} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 112]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 1860
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 112
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1919} {height 111} {dock_state bottom} {dock_on_new_line true}}
...
gui_sim_run Ucli -exe simv -args { -ucligui} -dir /DCNFS/users/student/xwei/Desktop/ELEN603/final/IMAGEPROC/tb -nosource
}
}
...
catch {gui_list_expand -id ${Hier.1} uvm_pkg}
catch {gui_list_select -id ${Hier.1} {{uvm_pkg.\m_uvm_resource_converter#(logic) }}}
...
gui_load_objects -child_scopes -scope Sim:uvm_pkg
gui_list_show_data -id ${Data.1} {uvm_pkg.\m_uvm_resource_converter#(logic) }
...
gui_open_source -id ${Source.1}  -replace -active imageproc_test_top.dut.compute_xy /DCNFS/users/student/xwei/Desktop/ELEN603/final/IMAGEPROC/tb/../rtl/imageproc.sv
...
gui_sch_show -window ${Schematic.1} -name imageproc_test_top.dut.compute_xy
gui_show_pin_value_annotate [gui_window_hier_name -window ${Schematic.1}]
gui_zoom -window ${Schematic.1} -rect { {-828 -38239} {60221 8500} }
