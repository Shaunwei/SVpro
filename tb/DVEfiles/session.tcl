...
# DVE full session
# Saved on Sat Nov 30 19:14:45 2013
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{-113 59} {1795 1139}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 263} {height 805} {dock_state left} {dock_on_new_line true} {child_hier_colhier 230} {child_hier_coltype 39} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 271} {height 805} {dock_state left} {dock_on_new_line true} {child_data_colvariable 155} {child_data_colvalue 66} {child_data_coltype 56} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
catch {gui_list_select -id ${Hier.1} {imageproc_test_top}}
...
gui_list_show_data -id ${Data.1} {imageproc_test_top}
...
gui_zoom -window ${Schematic.1} -rect { {3200 -69427} {127807 157} }
