...
# DVE full session
# Saved on Sat Nov 30 19:30:00 2013
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{4 84} {1911 1163}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 262} {height 805} {dock_state left} {dock_on_new_line true} {child_hier_colhier 230} {child_hier_coltype 39} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
set DLPane.1 [gui_create_window -type DLPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 271]
...
gui_set_window_pref_key -window ${DLPane.1} -key dock_width -value_type integer -value 271
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 805
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 270} {height 805} {dock_state left} {dock_on_new_line true} {child_data_colvariable 155} {child_data_colvalue 66} {child_data_coltype 56} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1907} {height 175} {dock_state bottom} {dock_on_new_line true}}
...
gui_set_env SIMSETUP::SIMARGS {+UVM_TESTNAME=test_rotate}
gui_set_env SIMSETUP::SIMEXE {./simv}
gui_set_env SIMSETUP::ALLOW_POLL {0}
if { ![gui_is_db_opened -db {/DCNFS/users/student/xwei/Desktop/ELEN603/final/IMAGEPROC/tb/simv}] } {
gui_sim_run Ucli -exe simv -args { +UVM_TESTNAME=test_rotate -ucligui} -dir /DCNFS/users/student/xwei/Desktop/ELEN603/final/IMAGEPROC/tb -nosource
}
}
